...
namespace MS.Services.Auth.Infra.Data.Migrations
{
    ...
    [Migration("20230826170009_IncludeDataCredentials")]
    partial class IncludeDataCredentials
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MS.Services.Auth.Core.Domain.DbContexts.Entities.ClientCredentials", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c8ae3d5a-521f-4278-a977-431c84a51aa5"),
                            ...
                            CreateDate = new DateTime(2023, 8, 26, 14, 0, 9, 681, DateTimeKind.Local).AddTicks(275),
                            Situation = 1
                        });
                });
            ...
            modelBuilder.Entity("MS.Services.Auth.Core.Domain.DbContexts.Entities.MapUserGroupRoles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8a758628-40f1-4df5-a57f-5dfe9c8257e8"),
